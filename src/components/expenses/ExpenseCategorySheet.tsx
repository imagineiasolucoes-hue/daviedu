...
const ExpenseCategorySheet: React.FC = () => {
  ...
  const addMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['expenseCategories', tenantId] });
      form.reset();
    },
    onError: (error) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="sm:max-w-lg overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Gerenciar Categorias de Despesa</SheetTitle>
          <SheetDescription>
            Adicione, visualize e remova categorias para organizar suas despesas.
          </SheetDescription>
        </SheetHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 p-4 border rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <Input id="name" {...form.register("name")} placeholder="Ex: Salários, Aluguel, Material de Limpeza" />
...
export default ExpenseCategorySheet;